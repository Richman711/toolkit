...
// CreateDirIfNotExist creates a directory, and all necessart parents, if it does not exist
...
// The final parameter, client, is optional. If non is specified, we use the standard http.Client.
func (t *Tools) PushJSONToRemote(uri string, data interface{}, client ...*http.Client) (*http.Response, int, error) {
	...
	// call the remote uri
	responce, err := httpClient.Do(request)
	if err != nil {
		return nil, 0, err
	}
	...
	// send response back
	return responce, responce.StatusCode, nil
}
